    ...
    def respond_to_assignment_request(self, issue_number, commenter):
        ...
        try:
            ...
            if suggested_keyword:
                ...
                keyword_explanation = (
                    "\n\n**Note**: We suggest "
                    f"`{suggested_keyword}` because {detection_reason}. "
                    "You can also use:\n"
            ...
            message_lines = [
                ...
                (
                    ...
                    " **you don't need to wait to be assigned** to start "
                    "working on an issue."
                ),
                "We encourage you to:",
                "",
                ...
                (
                    "2. **Open a Pull Request (PR) as soon as possible** "
                    "- even as a draft if it's still in progress"
                ),
                f"3. {linking_instruction}{keyword_explanation}",
                "",
                (
                    "Once you open a PR that references this issue, "
                    "you will be automatically assigned to it."
                ),
                "",
